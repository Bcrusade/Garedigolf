...
<div class="mec-gCalendar" id="mec_skin_<?php echo esc_attr($this->id); ?>">
	...
	<div class="mec-gCalendar-filters">
		<div class="mec-gCalendar-filters-wrap">
			...
			echo ($this->sf_reset_button ? '<div class="mec-search-reset-button col-md-2"><button class="button mec-button" id="mec_search_form_'.esc_attr($this->id).'_reset" type="button">'.esc_html__('Reset', 'mec').'</button></div>' : '');
			?>
		</div>
	</div>
</div>
