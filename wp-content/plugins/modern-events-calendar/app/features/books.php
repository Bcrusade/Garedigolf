                        ...
                        <?php if (!isset($attachment['error']) && $attachment['response'] === 'SUCCESS'): ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo esc_url($attachment['url']); ?>"
                                   target="_blank" rel="noopener noreferrer"><?php echo esc_html($attachment['filename']); ?></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
                                                    ...
                                                    <div class="mec-col-6">
                                                        ...
                                                        <?php /** File **/ elseif ($reg_field['type'] == 'file'): ?>
                                                            ...
                                                            <?php if ($attachments and is_array($attachments)): foreach ($attachments as $attachment): ?>
                                                                <a href="<?php echo esc_url($attachment['url']); ?>"
                                                                   target="_blank" rel="noopener noreferrer"><?php echo esc_html($attachment['filename']); ?></a> <?php endforeach;
                                                            endif; ?>
        ...
        foreach ($post_ids as $post_id)
        {
            ...
            foreach ($attendees as $key => $attendee)
            {
                ...
                if (class_exists('\MEC_Invoice\Attendee')) {
                    ...
                    $checkedin_timestamp = $has_checkedin  ? Attendee::get_checkedin_time( $invoiceId, $j, null ) : false;
                }
