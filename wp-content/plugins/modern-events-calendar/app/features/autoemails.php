...
class MEC_feature_autoemails extends MEC_base
{
    ...
    {
        $singular_label = esc_html__('Email', 'mec');
        $plural_label = esc_html__('Emails', 'mec');
    ...
    {
        add_meta_box('mec_email_metabox_details', esc_html__('Details', 'mec'), array($this, 'meta_box_details'), $this->PT, 'normal', 'high');
    }
