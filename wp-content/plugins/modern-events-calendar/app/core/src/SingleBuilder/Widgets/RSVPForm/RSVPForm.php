	...
	public function output( $event_id = 0, $atts = array() ){
		...
		if ( true === $this->is_editor_mode && !$is_rsvp_enabled ) {
			...
			$html = '<div class="mec-content-notification">
					<p>'
						.'<span>'
							. esc_html__('This widget is displayed if label is set. In order for the widget in this page to be displayed correctly, please set RSVP module for your last event.', 'mec')
						.'</span>'
						.'<a href="https://webnus.net/dox/modern-events-calendar/rsvp-events-addon/" target="_blank">' . esc_html__('How to set RSVP module', 'mec') . ' </a>'
					.'</p>'
				.'</div>';
