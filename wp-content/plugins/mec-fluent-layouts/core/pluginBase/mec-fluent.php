...
class MecFluent
{
    ...
    {
?>
        <h5 class="mec-form-subtitle"><?php esc_html_e('Fluent-view Layout Styles', 'mec'); ?></h5>
        <div class="mec-form-row">
            ...
            <div class="mec-col-9">
                <label id="mec_styling_disable_fluent_height_limitation">
                    <input type="hidden" name="mec[styling][disable_fluent_height_limitation]" value="0" />
                    <input value="1" type="checkbox" id="mec_styling_disable_fluent_height_limitation" name="mec[styling][disable_fluent_height_limitation]" <?php if (isset($styling['disable_fluent_height_limitation']) and $styling['disable_fluent_height_limitation']) echo 'checked="checked"'; ?> /><?php esc_html_e('Disable', 'mec'); ?>
                </label>
            </div>
        </div>
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label><?php esc_html_e('Main Color', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label><?php esc_html_e('Second Color', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label><?php esc_html_e('Button Hover Color', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label><?php esc_html_e('Background Color', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label><?php esc_html_e('Second Background Color', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
