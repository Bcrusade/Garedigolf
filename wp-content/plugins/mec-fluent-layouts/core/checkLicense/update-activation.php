 ...
 * @since       1.0.0
 */
class FluentAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MECFLUENTOPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MECFLUENTTEXTDOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MECFLUENTTEXTDOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MECFLUENTTEXTDOMAIN;
     ...
     * @access  public
     */
    public $name_string = MECFLUENTNAME;
     ...
     * @access  public
     */
    public $slug_string = MECFLUENTSLUG;
     ...
     * @access  public
     */
    public $main_file_path = MECFLUENTMAINFILEPATH;
    ...
    public function load_auto_update() {
        ...
        require_once MECFLUENTABSPATH.'/core/checkLicense/puc/plugin-update-checker.php';
