...
<div id="mec_book_payment_form" class="mec-booking-form-container mec-wrap-checkout row">
    ...
    <?php if($display_progress_bar): ?>
        <ul class="mec-booking-progress-bar">
            <li class="mec-booking-progress-bar-date-and-ticket mec-active"><?php esc_html_e('Select Ticket', 'mec'); ?></li>
            <li class="mec-booking-progress-bar-attendee-info mec-active"><?php esc_html_e('Attendees', 'mec'); ?></li>
            <li class="mec-booking-progress-bar-payment mec-active"><?php esc_html_e('Payment', 'mec'); ?></li>
            <li class="mec-booking-progress-bar-complete"><?php esc_html_e('Confirmation', 'mec'); ?></li>
        </ul>
    <?php else: ?>
        ...
        <div class="mec-booking-checkout-total-wrapper">
            <ul>
                <li>
                    ...
                    <span class="mec-book-price-discount"><?php echo MEC_kses::element($this->main->render_price((isset($price_details['discount']) ? $price_details['discount'] : 0), $event_id, false)); ?></span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span class="mec-book-price-payable"><?php echo MEC_kses::element($this->main->render_price($price_details['payable'], $event_id)); ?></span>
                </li>
                <?php endif; ?>
            </ul>
        </div>
