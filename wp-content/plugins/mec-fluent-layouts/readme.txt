...
== Changelog ==
= 1.6.6 - 1 January 2025 =
- Optimized: Styles and scripts loading
- Fixed: Some minor issues

= 1.6.5 - 18 March 2024 =
- Fixed: List view
- Fixed: Banner in single event

= 1.6.0 - 25 November 2023 =
- Added: Event time in Shortcode
- Added: German language file
- Fixed: Style Dropdown in Booking Form
- Fixed: Hourly schedule style
- Fixed: Main color

= 1.5.0 - 13 August 2023 =
- Added: Checkbox to display categories
- Added: FAQ section
- Fixed: CSS issues
- Fixed: Booking progress title
- Fixed: Some minor issues
